...
public class BoonelabFileFormat {
	...
	public BoonelabFileFormat(String filePath,String fileName, Integer fileNumber){
		FILE_PATH = filePath;
		FILE_NAME = fileName;
	...
	public static void createSGAFormattedFile(List<BoonelabFileFormat> boonelabFiles, ArrayDefinitionFileFormat arrayDef){
