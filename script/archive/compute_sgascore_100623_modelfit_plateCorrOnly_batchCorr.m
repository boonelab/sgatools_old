...
outputfile = 'Datasets/SGA_scores/fullgenome/10-07-19/sgascore_in090116_out100719_plateCorrOnly_batchCorr.txt';
...
sgadata.finalplatecorr_colsize = sgadata.(field);
% Save the workspace
% save('-v7.3',[outputfile,'_matfile']);
