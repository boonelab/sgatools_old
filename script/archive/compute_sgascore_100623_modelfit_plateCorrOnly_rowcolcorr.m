...
outputfile = 'Datasets/SGA_scores/fullgenome/10-07-19/sgascore_in090116_out100719_plateCorrOnly_rowcolcorr.txt';
...
sgadata.spatialnorm_colsize = sgadata.(field);
...
sgadata.finalplatecorr_colsize = sgadata.rowcolcorr_colsize;
